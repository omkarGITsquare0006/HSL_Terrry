<%@ Page Title="" Language="C#" MasterPageFile="~/HomePages/HomeMaster.Master" AutoEventWireup="true" CodeBehind="frmACCHMachineSup.aspx.cs" Inherits="HSL_Terrry.HomePages.frmACCHMachineSup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="card border-warning">
                <div class="card-header bg-warning" style="height: 50px;">
                    <p>AUTOMATIC CROSS CUTTING AND CROSS HEMMING REPORT</p>
                </div>
                <div class="card-body">
                    <asp:GridView ID="gvBeamList" runat="server" DataKeyNames="ID" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Transaction #">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkID" runat="server" Text='<%#Eval("ID") %>' PostBackUrl='<%# String.Format("frmACCHMachine.aspx?ID={0}", Eval("ID"))%>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
