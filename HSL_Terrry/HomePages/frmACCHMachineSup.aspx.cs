...
{
    public partial class frmACCHMachineSup : System.Web.UI.Page
    {
        ...
        protected void BindACCData()
        {
            DataTable dtBeam = new DataTable();

            dtBeam = CRUDApplication.Load_ACCApproval();
        ...
        private void LoadPODetail()
        {
            ...
            if (dtPODetails.Rows.Count > 0)
            {
                ...
                txtLotNo.DataSource = CRUDApplication.Load_LotNumberAcc(txtPO_No.SelectedValue.Trim());
        ...
        protected void btnClose_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int dtLotClose = CRUDApplication.Close_LotNumberAcc(txtPO_No.Text, txtLotNo.Text);
                if (dtLotClose > 0)
                {
