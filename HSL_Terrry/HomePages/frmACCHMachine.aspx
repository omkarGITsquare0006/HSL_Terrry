<%@ Page Title="" Language="C#" MasterPageFile="~/HomePages/HomeMaster.Master" AutoEventWireup="true" CodeBehind="frmACCHMachine.aspx.cs" Inherits="HSL_Terrry.HomePages.ACCHMachine" %>
    ...
    <body>
        <div class="container">
            <div class="row justify-content-left">
                <h5 class="mt-xl-3">AUTOMATIC CROSS CUTTING AND CROSS HEMMING ENTRY</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row pr-1">
                                ...
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <%--                            </div>--%>
                                    <%--                            <div class="col">--%>
                                    <asp:TextBox ID="txtdate" class="form-control" placeholder="Date" runat="server" AutoComplete="Off" />
                                ...
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <%--                            </div>--%>
                                    <%--                            <div class="col">--%>
                                    <asp:TextBox ID="txtoperator" class="form-control" placeholder="Operator" runat="server" AutoComplete="Off" />
                                    <%--                            </div>--%>
                                </div>
                                <%--</div>--%>
                                ...
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <%--                            </div>--%>
                                    <%--                            <div class="col">--%>
                                    <asp:TextBox ID="txtsupervisor" class="form-control" placeholder="Supervisor" runat="server" AutoComplete="Off" />
                                    <%--                            </div>--%>
                                </div>
                                <%--</div>--%>
                                <%--</div>--%>
                                ...
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <%--                            </div>--%>
                                    <%--                            <div class="col">--%>
                                    <asp:TextBox ID="txttrollyno" class="form-control" placeholder="Trolley Number" runat="server" AutoComplete="Off" />
                                    <%--                            </div>--%>
                                </div>
                                <%--</div>--%>
                                ...
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <%--                            </div>--%>
                                    <%--                            <div class="col">--%>
                                    <asp:TextBox ID="txtprodwt" class="form-control font-weight-bold" placeholder="Produced Weight" runat="server" />
                                    <%--                            </div>--%>
                                </div>
                                <%--</div>--%>
            ...
            $(document).ready(function () {
                $("#<%=txtPO_No.ClientID%>").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: "frmACCHMachine.aspx/GetPoNum",
                            method: "post",
