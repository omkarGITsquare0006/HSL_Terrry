    ...
    public partial class ACCHMachine : System.Web.UI.Page
    {
        ...
        private void BindListView()
        {
            ...
            try
            {
                ...
                cmdDistrict.Parameters.Add("@Operation", SqlDbType.Char).Value = "ACCHM";
                ...
                cmdDistrict1.Parameters.Add("@Operation", SqlDbType.Char).Value = "ACCHM";
        ...
        protected void Load_Master()
        {
            try
            {
                ...
                txtstopreason.DataSource = CRUDApplication.Load_Master("ACCHM", "Stoppage");
