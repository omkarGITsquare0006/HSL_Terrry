...
namespace HSL_Terrry.HomePages
{
    ...
    {
        ILog logger = log4net.LogManager.GetLogger("[Manual Cross Hemming]");
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (strID != null)
                {
                    ...
                    txtprodpcs.ReadOnly = true;
                    txtprodwt.ReadOnly = true;
        ...
        private void BindListView()
        {
            ...
            try
            {
                ...
                cmdDistrict.Parameters.Add("@Operation", SqlDbType.Char).Value = "MCH";
                ...
                cmdDistrict1.Parameters.Add("@Operation", SqlDbType.Char).Value = "MCH";
        ...
        protected void Load_Master()
        {
            try
            {
                ...
                ddMachineNo.DataSource = CRUDApplication.Load_Master("MCH", "Machine");
                ...
                txtrejreason.DataSource = CRUDApplication.Load_Master("MCH", "Reject");
                ...
                txtstopreason.DataSource = CRUDApplication.Load_Master("MCH", "Stoppage");
        ...
        {
            DataTable dtPODetails = CRUDApplication.Load_PODetailsOnPONumberMch(txtPO_No.Text.Trim());
        ...
        protected void Btn_submit(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = CRUDApplication.AddNewrecordMch(txtPO_No.Text.Trim(), Convert.ToDateTime(txtdate.Text.Trim()), ddShift.SelectedValue, txtoperator.Text.Trim(),
        ...
        protected void btn_Update(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = CRUDApplication.UpdaterecordMch(Convert.ToInt32(textID.Text.Trim()), txtPO_No.Text.Trim(), Convert.ToDateTime(txtdate.Text.Trim()), ddShift.SelectedValue, txtoperator.Text.Trim(),
                    txtsupervisor.SelectedValue, ddMachineNo.SelectedValue, Convert.ToString(txttrollyno.SelectedValue), Convert.ToInt32(txttrollyqty.Text.Trim()),
                    Convert.ToInt32(txtnoofslits.Text.Trim()), Convert.ToInt32(txtprodpcs.Text.Trim()),
                    Convert.ToInt32(txtrejQty.Text.Trim()), txtrejreason.SelectedValue, Convert.ToDecimal(txtprodwt.Text.Trim()),
        ...
        public static string[] GetPoNum(string term)
        {
            ...
            try
            {
                listPoNum = CRUDApplication.Load_PONumber_Auto("Mch_status", term);
            }
            catch (Exception ex)
            {
                MsgBox1.MessageBox.Show("Error while Getting PO Number!!!");
