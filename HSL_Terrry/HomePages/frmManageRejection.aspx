<%@ Page Title="" Language="C#" MasterPageFile="~/HomePages/HomeMaster.Master" AutoEventWireup="true" CodeBehind="frmManageRejection.aspx.cs" Inherits="HSL_Terrry.HomePages.frmManageRejection" %>
        ...
        <div class="container-fluid pr-0 pl-0">
            <div class="card border-warning mt-3">
                <div class="card-header bg-warning" style="height: 50px;">
                    <p class="font-weight-bold">MANAGE REJECT REASONS</p>
                </div>
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-5 p-2">
                         ...
                         <div class="form-group col-md-2 p-2">
                            ...
                            <button type="button" id="btnView" class="btn btn-light p-0" data-toggle="modal" data-target="#exampleModal"><span class="small">view or manage rejects</span></button>
                        </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Rejection Master</h5>
